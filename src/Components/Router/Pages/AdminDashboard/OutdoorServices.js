...
const OutdoorServices = () => {
    ...
    const handleAddServices = event => {
        ...
        const name = event.target.outdoorServices.value;
        const servicesCategory = 'Outdoor services';
        ...
        <div
            ...
            <h1 style={{ fontFamily: 'Noto Serif Bengali, serif' }} className='
                ...
                '>
                    ...
                    {/* <ul class="list-disc">
                                    {services?.map(service => <li>{service.serviceName}। | </li>)}
                                </ul> */}
            ...
            {isShown2 ?
                <>
                    ...
                    <form onSubmit={handleAddServices}>
                        <input className="input input-bordered w-full max-w-3xl  
                            ...
                            mx-auto p-5"   type={"text"} name={'outdoorServices'} placeholder={"Edit outdoor services"}>
                        </input>
                ...
                :
                <>
                    <button className='btn  btn-error   m-5 ' onClick={handleClick2}>Add services</button>
                </>
            }
        </div>
    );
